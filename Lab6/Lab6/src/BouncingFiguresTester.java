...
//		box.add(figure2);
//		BouncingFigure figure3 = new BouncingRectangle(90, 570, 10, 10, 30.0, 90);
//		box.add(figure3);
//		BouncingFigure figure4 = new BouncingRectangle(360, 610, 10, 10, 310.0, 80);
//		box.add(figure4);
//		BouncingFigure figure5 = new BouncingRectangle(500, 600, 10, 10, 90.0, 50);
//		box.add(figure5);
//		BouncingFigure figure6 = new BouncingRectangle(200, 100, 10, 10, 360.0, 50);
//		box.add(figure6);
//		frame.add(box);
		BouncingFigure figure7 = new BouncingCircle(360, 300, 10,10, 310.0, 80);
		box.add(figure7);
		frame.add(box);
